...
/**
 * just wrappe java.sql.PreparedStatement for writing query
 *
 *
 */
public class LoggableStatement implements PreparedStatement {
	...
	public String getQueryString() {
		...
		while (tok.hasMoreTokens()) {
			...
			try {
				...
				if(value instanceof String) {
					String _value = (String)value;
					if(_value.length()>100) _value = _value.substring(0, 100)+"...";
				}
    ...
    public void setURL(int i , java.net.URL url) throws SQLException{
		wrappedStatement.setURL(i,url);
    }

    public boolean execute(String s, String arr[]) throws SQLException{
		return wrappedStatement.execute(s,arr);
    }


    public int executeUpdate(String s, String arr[]) throws SQLException{
		return wrappedStatement.executeUpdate(s,arr);
    }//*/
