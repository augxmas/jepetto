...
public class XcelReader {
	...
	/**
	 * cursor媛� sheet瑜� 媛뽮퀬 �엳�뒗吏� �뙋�떒�븯�뒗 硫붿냼�뱶, �닚諛⑺뼢�쑝濡쒕쭔 sheet 寃��깋�쓣 �븷 �닔 �엳�떎
	...
	/**
	 * positioning �맂 sheet�뿉 row瑜� 媛뽮퀬 �엳�뒗吏� �뙋�떒�븯�뒗 硫붿냼�뱶
	 * �닚諛⑺뼢�쑝濡쒕쭔 row 寃��깋�쓣 �븷 �닔 �엳�떎
	 * @return row�쓽 議댁옱 �쑀臾�
	 */
	...
	/**
	 * positioning�맂 row�뿉 cell�쓣 媛뽮퀬 �엳�뒗吏� �뙋�떒�븯�뒗 硫붿냼�뱶
	 * �닚諛⑺뼢�쑝濡쒕쭔 cell 寃��깋�쓣 �븷 �닔 �엳�떎
	...
	/**
	 * 二쇱뼱吏� 寃쎈줈�뿉 濡쒕뵫�릺�뼱 �엳�뒗 xls瑜� csv濡� 蹂��솚. cell�뿉 媛믪씠 議댁옱�븯吏� �븡�쓣 寃쎌슦 '.'濡쒖꽌 ��泥댄븯�뿬 �깮�꽦�븳�떎
	 * @param path
	 * @param file
